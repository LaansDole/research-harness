...
4. Persist every verdict:
   `python3 <skill>/scripts/review.py --project <slug> verdict --id <id> --stage <ta|ft> --verdict <include|exclude|maybe> --rationale "<evidence-based sentence>" --confidence <0.0-1.0> [--reason "<first failed dimension>"]`
