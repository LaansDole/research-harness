...
_[Watch the capture ↗](https://laansdole.github.io/research-harness/#litreview)_ — recorded before research mode existed: `/litreview` and the paper graph, both still current, but not the mode's command set, `review.db`, or the PRISMA-ScR diagram.
...
_[Watch the capture ↗](https://laansdole.github.io/research-harness/#paper-graph)_ — also recorded before research mode existed; the graph commands shown are unchanged.
